...
const UI = (() => {
  ...
  function buildHelp() {
    ...
    el("help-body").innerHTML = `
      ...
      <p>When a stranger offers to join, you can also <b>Attack &amp; Loot</b> them — turn on
      even a friendly survivor to seize the food they carry. You strike first, but a tough
      one will fight back, and you forfeit the chance to recruit them.</p>
      <p><b>Casting someone out</b> of your party (✕ on their card) leaves them behind in the
      world as a wandering survivor — they lose a point of trust for the betrayal, and if they
      were infected, you'll see them turn into a zombie where they roam when their timer runs out.</p>
